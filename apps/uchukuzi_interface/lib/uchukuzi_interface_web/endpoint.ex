defmodule UchukuziInterfaceWeb.Endpoint do
  ...
  socket "/socket", UchukuziInterfaceWeb.CustomerSocket,
    websocket: [timeout: 45_000],
    longpoll: false

  socket "/socket/assistant", UchukuziInterfaceWeb.AssisantSocket,
    websocket: [timeout: 45_000],
    longpoll: false
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_uchukuzi_interface_key",
    signing_salt: "4BouRuKD"

  plug UchukuziInterfaceWeb.Router
end
