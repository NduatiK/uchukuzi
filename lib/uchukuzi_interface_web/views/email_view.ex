defmodule UchukuziInterfaceWeb.EmailView do
  ...
  def render_html(%Uchukuzi.Roles.CrewMember{} = assistant, token) do
              ...
              <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;">
                <tr>
                  <td class="email-masthead" style="word-break: break-word; font-family: Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; padding: 25px 0;" align="center">
                    <a href="https://uchukuzi.gigalixirapp.com" class="f-fallback email-masthead_name" style="color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                    Uchukuzi
                  </a>
                  </td>
                </tr>
                              ...
                              <tr>
                                <td align="center" style="word-break: break-word; font-family: Helvetica, Arial, sans-serif; font-size: 16px;">
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                    <tr>
                                      <td align="center" style="word-break: break-word; font-family: Helvetica, Arial, sans-serif; font-size: 16px;">
                                        <a href="#{link}" class="f-fallback button button--green" target="_blank" style="color: #FFF; border-color: #61A591; border-style: solid; border-width: 10px 18px; background-color: #61A591; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Access account</a>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                            ...
                            <table class="body-sub" role="presentation" style="margin-top: 25px; padding-top: 25px; border-top-width: 1px; border-top-color: #EAEAEC; border-top-style: solid;">
                              <tr>
                                <td style="word-break: break-word; font-family: Helvetica, Arial, sans-serif; font-size: 16px;">
                                  ...
                                  <!--                              <p class="f-fallback sub" style="font-size: 13px; line-height: 1.625; color: #6B6E76; margin: .4em 0 1.1875em;">uchukuzi://uchukuzi.com/?token=#{token}</p> -->
    <a href=#{link} class="f-fallback sub" style="font-size: 13px; line-height: 1.625; color: #6B6E76; margin: .4em 0 1.1875em;">#{link}</a>
                                </td>
                              </tr>
                            </table>
                          </div>
  ...
  def render_text(%Uchukuzi.Roles.CrewMember{} = assistant, token) do
    """
    Use this link to reset your password. The link is only valid for 1 hour.

    Uchukuzi ( https://uchukuzi.gigalixirapps.com )
    ...
    ************
    ...
    Access account (uchukuzi://uchukuzi.com/?token=#{token})
    ...
    uchukuzi://uchukuzi.com/?token=#{token}
